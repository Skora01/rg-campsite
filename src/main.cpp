...
struct ProgramState {
    ...
    glm::vec3 ratPosition = glm::vec3(5.0f, 0.0f, 5.0f);
...
int main() {
    ...
    /*
         Mozete probate da stavite brick teksturu na kojoj se bolje primeti uticaj parallax mapping-a
     */
    //load skybox
